...
const QuestionCard: React.FC<QuestionCardProps> = ({
  ...
  // For blank questions, "CORRECT" string in selectedOptionId means user marked it right
  ...
  }, [showResult, question.id, isChoice]);
    ...
    >
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="text-lg font-medium text-slate-800 dark:text-slate-100 flex-1 mr-8">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className={`text-xs px-2 py-0.5 rounded ${question.type === 'choice' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300' : 'bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300'}`}>
      ...
      {showResult && (
        <div className="mt-4 animate-fadeIn">
          {/* Result Header (Different for Choice vs Blank) */}
            ...
            <div className="flex items-center font-bold">
              {isCorrect ? (
                ...
                <>
                  ...
                  <span>{isChoice ? `正确答案: ${question.correctOptionId}` : '需复习'}</span>
                </>
              )}
            </div>
